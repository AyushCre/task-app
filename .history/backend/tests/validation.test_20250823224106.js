...
describe('Validation Middleware', () => {
  ...
  describe('handleValidationErrors', () => {
    it('should call next if no validation errors', () => {
      ...
      // Mock validationResult to return no errors by setting a mock on the request
      req.validationResult = jest.fn().mockReturnValue({
        isEmpty: () => true,
        array: () => []
      });
    ...
    it('should throw AppError with validation details if errors exist', () => {
      ...
      // Mock validationResult to return errors by setting a mock on the request
      req.validationResult = jest.fn().mockReturnValue({
        isEmpty: () => false,
        array: () => [
